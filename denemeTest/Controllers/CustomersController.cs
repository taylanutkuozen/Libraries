...
//using denemetest.FluentValidators;
namespace denemetest.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerName,CustomerMail,CustomerAge,BirthDay")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,CustomerName,CustomerMail,CustomerAge")] Customer customer)
        {
            if (id != customer.ID)
            {
                return NotFound();
